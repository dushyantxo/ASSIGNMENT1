...
\begin{align}
\vec{n}_{AB}^{\top}\brak{\vec{x}-\vec{C}}&=0 \\
\myvec{-7 \\5}^\top\brak{\vec{x}-\myvec{-3\\-5}}&=0 \\
\myvec{-7 & 5}\brak{\vec{x}-\myvec{-3\\-5}}&=0  \\
\myvec{-7\\5}^\top\vec{x}=-4
\end{align}
\item The equation of line $\vec{B}$$\vec{E_{1}}$ 
\end{enumerate}
\begin{align}
\vec{n}_{AC}^{\top}\brak{\vec{x}-\vec{B}}&=0 \\
\myvec{4 \\-4}^\top\brak{\vec{x}-\myvec{-4\\6}}&=0 \\
\myvec{4 & -4}\brak{\vec{x}-\myvec{-4\\6}}&=0  \\
\myvec{4\\-4}^\top\vec{x}&=-40
\end{align}
\begin{figure}[H]
